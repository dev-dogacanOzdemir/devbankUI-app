...
const AdminCurrencyGoldPage = () => {
    ...
    // Backend endpointlerini tetikleyen butonlar
    const handleFetchCurrencies = async () => {
        try {
            await fetch('http://localhost:2003/api/currency-rates/fetch', { method: 'POST' });
    ...
    const handleFetchGoldRates = async () => {
        try {
            await fetch('http://localhost:2003/api/gold-rates/fetch', { method: 'POST' });
            ...
            <Card shadow="sm" padding="lg" radius="md" withBorder style={{ width: '80%' }}>
                <Group position="apart">
                    ...
                    <Group>
                        ...
                        />
                        <StyledButton
                            label="Fetch Gold Rates"
                            onClick={handleFetchGoldRates}
                            color="#b68d3d"
                        />
                    </Group>
                </Group>
...
export default AdminCurrencyGoldPage;
